...
export function HomeTodayStatus(){const status=useTripStatus();if(status.phase==="pending")return <section className="home-today home-today-loading"><div className="home-today-head"><span>DATE CHECK</span><strong>日期確認中</strong></div><h2>正在以台北時間確認旅程狀態</h2><p>載入後會顯示出發前預覽或真正的今日重點。</p></section>;const day=itinerary[status.day-1];return <section className="home-today">
